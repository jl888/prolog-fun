crossword-puzzle(V1,V2,V3,H1,H2,H3) :-
	word(V1, V1_1, V1H1, V1_3, V1H2, V1_5, V1H3, V1_7),
    word(V2, V2_1, V2H1, V2_3, V2H2, V2_5, V2H3, V3_7),
    word(V3, V3_1, V3H1, V3_3, V3H2, V3_5, V3H3, V4_7),
...
test_answer :-
    findall((V1,V2,V3,H1,H2,H3), crossword-puzzle(V1,V2,V3,H1,H2,H3), L),
    sort(L,S), 
